...
| Créer un personnage | [README.md](README.md#-comment-utiliser) |
| Faire un jet | [README.md](README.md#-système-de-jets) |
| Comprendre les compétences | [README.md](README.md#-structure-des-attributs--compétences) |
| Types d'objets (armes, armures, munitions…) | [ITEM_TYPES_GUIDE.md](ITEM_TYPES_GUIDE.md) |

### COMBATTANTS - Système de combat

| Besoin | Document |
|--------|----------|
| Dégâts mêlée (table Force × Degré) | [DAMAGE_SYSTEM.md](DAMAGE_SYSTEM.md) |
...
| Besoin | Document |
|--------|----------|
| Installer le système (manifest URL) | [INSTALLATION.md](INSTALLATION.md) |
| Publier une release | [PUBLISH_CHECKLIST.md](PUBLISH_CHECKLIST.md) |
| Exemple de manifest | [EXAMPLE_MANIFEST.md](EXAMPLE_MANIFEST.md) |
...
1. [README.md](README.md) — Guide principal (attributs, compétences, onglets, jets)
2. [ITEM_TYPES_GUIDE.md](ITEM_TYPES_GUIDE.md) — Types d'items et acteurs avec schémas à jour
3. [DAMAGE_SYSTEM.md](DAMAGE_SYSTEM.md) — Dégâts mêlée + moteur balistique + **blessures par localisation**
4. [COMBAT_SYSTEM.md](COMBAT_SYSTEM.md) — Mouvement, corpulence, tables de calcul
5. [COMBAT_STATISTICS.md](COMBAT_STATISTICS.md) — 8 statistiques de combat, hooks, exemples
6. [SKILL_PREREQUISITES.md](SKILL_PREREQUISITES.md) — 13 compétences avec prérequis
